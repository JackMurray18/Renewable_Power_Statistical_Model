...
```{r readin}
data_files <- list.files("C:/Users/jackm/Desktop/Data Science/Project/TIDY_SOLAR_DATA")

for(i in 1:length(data_files)) 
{                              
  assign(
    paste0("data", i),                                
    read.csv(paste0("C:/Users/jackm/Desktop/Data Science/Project/TIDY_SOLAR_DATA/",data_files[i])))
}
```
